 ...
 * @author Shawn
 */
public class BadMonsterDaoEFileImplTest {
    
     MonsterDao testDao = new BadMonsterDaoEFileImpl();
    
    public BadMonsterDaoEFileImplTest() {
    }
    ...
    @Test
    public void testAddGetMonsterThenList() {
