 ...
 * @author Shawn
 */
public class BadMonsterDaoFFileImplTest {
    

    
    MonsterDao testDao = new BadMonsterDaoFFileImpl();
    
    public BadMonsterDaoFFileImplTest() {
    }
    ...
    public void setUp()throws Exception {
        ...
        testDao = new BadMonsterDaoFFileImpl(testFile);
    }
    @Test
