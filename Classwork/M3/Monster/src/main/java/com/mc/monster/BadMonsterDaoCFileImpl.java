 ...
 * @author Shawn
 */
public class BadMonsterDaoCFileImpl implements MonsterDao {
    ...
    public List<Monster> getAllMonsters() {
        ...
        for (Monster m : manyMonsters) {
            manyMonsters.add(m);    //list manyMonsters is empty, need to iterate through monsters list
        }
        return manyMonsters;
    }
